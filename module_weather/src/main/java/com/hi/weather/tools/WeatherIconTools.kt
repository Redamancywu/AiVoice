...
object WeatherIconTools {
    ...
    fun getWeatherIcon(weather: String): Int {
        when (weather) {
            "晴" -> return R.drawable.ic_clear_day
            "多云" -> return R.drawable.ic_cloudy
            "阴" -> return R.drawable.ic_heavy_haze
            "阵雨" -> return R.drawable.ic_hail
